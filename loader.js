...
const assetNames = ['block1.png','bullet.png','hero.gif', 'yellowPlane.png','water.png', 'promo2.png', 'promo.png', 'car.png','enemy.gif', 'pipe.png', 'background.png', 'block.png','bus.png',];
